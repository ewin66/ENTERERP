...
namespace EnterWEB.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class EnterWEBAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private EnterERP.Module.EnterERPModule module3;
        private EnterWEB.Module.Web.EnterWEBAspNetModule module4;
        ...
        public EnterWEBAspNetApplication() {
            InitializeComponent();
        ...
        private void EnterWEBAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new EnterWEB.Module.Web.EnterWEBAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.EnterWEBAspNetApplication_DatabaseVersionMismatch);
