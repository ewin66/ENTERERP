...
namespace EnterERP.Module.BusinessObjects
{
    ...
    public class CXCConceptos : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public CXCConceptos(Session session)
            : base(session)
        {
        }
        ...
        public string Concepto
        {
            ...
            set
            {
                SetPropertyValue("Concepto", ref concepto, value);
            }
        }

        public enum TipoConcepto : int { Debito = 1, Credito = 2 }
