...
namespace EnterERP.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class EnterERPAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private EnterERP.Module.EnterERPModule module3;
        private EnterERP.Module.Web.EnterERPAspNetModule module4;
        ...
        public EnterERPAspNetApplication() {
            InitializeComponent();
        ...
        private void EnterERPAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new EnterERP.Module.Web.EnterERPAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.EnterERPAspNetApplication_DatabaseVersionMismatch);
